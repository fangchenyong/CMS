	...
	<div class="layui-form layui-form-pane">
	  ...
	  <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
		      <input type="text" id="name" autocomplete="off" value="${link.name }" v-model="name" placeholder="请输入名称" class="layui-input">
	    </div>
	  </div>
	  ...
	  <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
		      <input type="text" id="trueName" autocomplete="off" value="${link.url }" v-model="url" placeholder="请输入  地址" class="layui-input">
	    </div>
	  </div>
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline" style="width: 100px;" >
					<c:choose>
						...
						<c:when test="${link.isUse==0 || link.isUse==null }">
	  ...
	  <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
		      <input type="text" id="remark" autocomplete="off" v-model="remark" value="${link.remark}" placeholder="请输入备注" class="layui-input">
	    </div>
	  </div>
